...
/**
 * Created by Anup Dey on 12-Aug-17.
 */

public class FloatingActionMenuBehaviorSnackbar extends CoordinatorLayout.Behavior {

    private float mTranslationY;

    public FloatingActionMenuBehaviorSnackbar(Context context, AttributeSet attrs) {
        super();
    }
    ...
    private void updateTranslation(CoordinatorLayout parent, View child, View dependency) {
        ...
        if (translationY != this.mTranslationY) {
            ...
            if (Math.abs(translationY - this.mTranslationY) == (float) dependency.getHeight()) {
                ...
                ViewCompat.animate(child).translationY(translationY).setListener((ViewPropertyAnimatorListener) null);
            } else {
